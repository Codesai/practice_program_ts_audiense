...
export class Recipe {
    ...
    craft(bouquet: Bouquet, priceProvider: DeprecatedPriceProvider): Bouquet {
        for (const element of this.elements) {
            this.addElementToBouquet(priceProvider, element, bouquet);
        }
        return bouquet
    }

    private addElementToBouquet(priceProvider: DeprecatedPriceProvider, element: Element, bouquet: Bouquet): void {
