...
> As a staff member entering a valid code, when the door jams, a specific error is displayed on the keypad display, so
> that I can call a technician.
> As a staff member, when I enter an incorrect code on the keypad and the door does not unlock, a specific error is
> displayed on the keypad display to let me know.
