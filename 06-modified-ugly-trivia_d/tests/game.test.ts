...
describe('Ugly trivia', () => {
  ...
  it('a repeatable simulation with high coverage', () => {
    ...
    const rollNumbers: Array<number> = [
      6, 3, 1, 1, 2, 1, 6, 1, 1, 4, 4, 3, 2, 1, 4, 3, 4, 1, 1, 6, 4, 2, 2, 3, 1, 5, 6, 1, 1, 2, 2, 3, 6, 1, 3, 2,
    ];
    ...
    const game = new ExtendedGame(rollNumbers, answersAreWrong, instance(notifier));
  ...
  class ExtendedGame extends Game {
    ...
    constructor(rollNumbers: Array<number>, answersAreWrong: Array<boolean>, notifier: Notifier) {
      super(notifier);
  ...
  function getCallsArguments() {
    const calls: { actions: Array<{ args: Array<string> }> } = capture(notifier.notify) as any as {
      actions: Array<{ args: Array<string> }>;
    };
