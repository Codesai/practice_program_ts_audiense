...
// Generated initially interacting with openai-GPT-4o, then I fixed the ` extractOptions ` method and refactored the class a bit.
// From then on I started evolving it myself.
...
const AllowedOptionKeys = ["noshow", "minfreq", "max", "nocase"] as const;
